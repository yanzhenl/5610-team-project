...
import { editProfile } from "./farmer-reducer";
...
function EditFarmerProfile () {
    ...
    return(
        <div>
            <div className="row">
                <div className="col-1">
                    <Link to="/profile/farmer"><i className="bi bi-x-lg text-muted"></i></Link>
                </div>
                <div className="col-9">
                ...
                <div className="position-relative">
                    <img src = {farmer.bannerPicture} className="img-fluid mt-2 mb-4 banner" alt=""/>
                    <img src = {farmer.profilePicture} className="rounded-circle profile-picture-edit ms-3" alt=""/>
                </div>
            </div>
