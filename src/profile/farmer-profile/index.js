        ...
        <div>
            <div className="row">
                ...
                <div className="col-11">
                    <div className="fw-bold">{farmer.firstName} {farmer.lastName}</div>
                </div>
                <img src = {farmer.bannerPicture} className="img-fluid banner" alt=""/>
                <div className="row mt-2">
                    <div className="col-1">
                        <img src = {farmer.profilePicture} className="rounded-circle profile-picture ms-3" alt=""/>
                    </div>
                    <div className="col-9">
                        <div className="fw-bold ms-4 mt-4">{farmer.firstName} {farmer.lastName}</div>
            ...
            <div>
                ...
                <div className="text-muted ms-3 mt-2">
                    ...
                    <span className="fw-bold text-black ms-3">{farmer.followersCount}</span>
